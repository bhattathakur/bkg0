{
  ...
  const char * filname="ROOTFILES/bkg0final.root"; //access the original histogram
  const  char * finalallhistograms="ROOTFILES/bkg0final_allhistogram.root";
  char  estimated_parameter_files[]="DATA/bkg0finalestimates.dat"; //file storing the estimated parameters for fit
  char  finaloutputfile[] ="DATA/bkg0finalEnergyerror.dat"; //Output file to store A,u,6,eA,eu,e6
