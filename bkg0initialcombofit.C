{
  ...
  const char * filename="ROOTFILES/bkg0initial.root"; //access the original histogram
  const char * allhistogramsfile="ROOTFILES/bkg0initial_allhistogram.root"; //Dave the histogram
  char  file_estimated_parameters[]="DATA/bkg0initialestimates.dat"; //file storing the estimated parameters for fit
  char  outputfile[] ="DATA/bkg0initialEnergyerror.dat";
  char initialcanvaspdf[]="PLOT/bkg0initialcanvas.pdf";
  const  int peakNo=23;
  const  int column=6;
