{
  ...
  const char * input1="DATA/bkg0initialEnergyerror.dat"; //estimated energy from the fit parameters
  const  char * input2="DATA/tabulated_energy.dat"; //true energy calculated from nudat2
  const char * output="DATA/bkg0E_estandE_true.dat";//storing the data manipulated from input1 and input2
